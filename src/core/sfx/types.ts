...
export const SFX_IDS = ['hit', 'canister', 'smash', 'coin', 'nitroReady', 'nitroStart', 'nitroEnd', 'rocketPrepare', 'rocketLaunch', 'rocketEnd', 'jump', 'land', 'slideStart', 'slideEnd', 'lane', 'nearMiss', 'combo', 'mode', 'gameOver', 'hoof', 'fullRepair'] as const;
